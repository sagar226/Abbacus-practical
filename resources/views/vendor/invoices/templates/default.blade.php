...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    <td class="border-0 pl-0" width="70%">
                        <h2 class="text-uppercase" style="padding-left:134px;font-size:35px;">
                            {{ $invoice->name }}
                        </h2>
                    </td>
        ...
        <table class="table center">
            <thead>
                <tr>
                    <th scope="col" class="border-0 pl-0" style="font-size:25px;">{{ "TITLE" }}</th>
                    <th class="col" style="padding-left:30px"></th>
                    <th scope="col" class="text-center border-0 pr-0" style="font-size:25px;" >{{ "AMOUNT" }}</th>
                </tr>
            </thead>
            <tbody>
                {{-- Items --}}
                ...
                <tr>
                    <td class="pl-0" style="font-size:17px">{{ $item->title }}</td>
                    <td class="pl-0"></td>
                    <td class="pr-0" style="font-size:17px;padding-left:15px">
